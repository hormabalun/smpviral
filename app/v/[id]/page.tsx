...
export default async function Video({ params }: PageProps) {
    ...
    const file = data.result[0];
        ...
        url: `https://smpviralbocil.pages.dev/v/${file.filecode}#${file.title}`,
        ...
        interactionStatistic: {
            ...
            interactionType: {
                '@type': `ReadAction`,
                target: `https://smpviralbocil.pages.dev/v/${file.filecode}#${file.title}`
            }  
        }
        }
    return (
